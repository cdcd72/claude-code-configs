---
description: 執行提交與推送流程 (符合 Conventional Commits 規範)
allowed-tools: PowerShell(git branch:*), PowerShell(git checkout:*), PowerShell(git status:*), PowerShell(git diff:*), PowerShell(git add:*), PowerShell(git commit:*), PowerShell(git push:*)
metadata:
  author: Neil
  version: '2026.6.19'
---
...
請根據目前工作區的實際變更，完成一次符合 Conventional Commits 的 Git 提交，並將變更推送到遠端倉庫。
